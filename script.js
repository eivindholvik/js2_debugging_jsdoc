 ...
 * @typedef {string} AnimalType
 */

/**
 * console logging out an animal
 * @param {AnimalType} x Name of an animal
 ...
 * ```
 */
const logAnimal = (x) => console.log(x);
